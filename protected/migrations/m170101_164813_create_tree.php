...
class m170101_164813_create_tree extends CDbMigration
{
	public function up()
	{
		...
		$this->addForeignKey('FK_parent','tree','parent_id', 'tree' ,'id','CASCADE','CASCADE');
		$this->insert('tree',['id' => '1',
			'name' => 'root'
		]);
		//$this->update('tree',['id' => '0'],['id' => '1']);

		$this->insert('tree',['id' => '2', 'name' => 'group1', 'parent_id' => '1']);
		...
		$this->insert('tree',['id' => '6', 'name' => 'group5', 'parent_id' => '1']);
